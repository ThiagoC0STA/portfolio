...
export const projects = [
  {
    ...
    iconLists: getIconList("Cubit, Flutter, Clean Architecture, Firebase, Figma"),
    link: "",
    sourceCode: "https://github.com/ThiagoC0STA/ambev-tergo",
    type: "mobile"
  },
  {
    id: 8,
    ...
    iconLists: getIconList("HTML5, CSS3, JavaScript, Figma, Tailwind css, Design advanced"),
  ...
  },
  {
    ...
    iconLists: getIconList("HTML5, CSS3, JavaScript, React, Next.js, Figma, Tailwind css, React native"),
  ...
  },
  {
    ...
    iconLists: getIconList("HTML5, CSS3, JavaScript, React, Next.js, Figma, Tailwind css"),
  ...
  },
  {
    ...
    iconLists: getIconList("Flutter, Dart, C++, swift, kotlin, Figma, Tailwind css"),
  ...
  },
  {
    ...
    iconLists: getIconList("HTML5, CSS3, JavaScript, React, Next.js, Figma, Styled components, Framer-Motion"),
  ...
  },
  {
    ...
    iconLists: getIconList("HTML5, CSS3, JavaScript, React, Figma, Next.js, Typescript, Styled components"),
...
export const frontendTechsRow1 = [
  { name: "HTML5", icon: SiHtml5, color: "#e44d26", subtitle: "Markup", doc: "https://developer.mozilla.org/docs/Web/HTML" },
  { name: "CSS3", icon: SiCss3, color: "#1572b6", subtitle: "Style", doc: "https://developer.mozilla.org/docs/Web/CSS" },
  { name: "Sass", icon: SiSass, color: "#cc6699", subtitle: "Preprocessor", doc: "https://sass-lang.com/documentation" },
  { name: "PostCSS", icon: SiPostcss, color: "#dd3a0a", subtitle: "Tooling", doc: "https://postcss.org/" },
  { name: "Tailwind", icon: SiTailwindcss, color: "#38bdf8", subtitle: "Utility CSS", doc: "https://tailwindcss.com/docs" },
  { name: "Bootstrap", icon: SiBootstrap, color: "#7952b3", subtitle: "UI Kit", doc: "https://getbootstrap.com/docs/5.0/getting-started/introduction/" },
  { name: "Chakra UI", icon: SiChakraui, color: "#319795", subtitle: "UI Kit", doc: "https://chakra-ui.com/docs" },
  { name: "JavaScript", icon: SiJavascript, color: "#f7df1e", subtitle: "Language", doc: "https://developer.mozilla.org/docs/Web/JavaScript" },
  { name: "TypeScript", icon: SiTypescript, color: "#3178c6", subtitle: "Language", doc: "https://www.typescriptlang.org/docs/" },
  { name: "React.js", icon: SiReact, color: "#61dafb", subtitle: "Library", doc: "https://react.dev/learn" },
  { name: "Next.js", icon: SiNextdotjs, color: "#fff", subtitle: "Framework", doc: "https://nextjs.org/docs" },
  { name: "Redux", icon: SiRedux, color: "#764abc", subtitle: "State", doc: "https://redux.js.org/introduction/getting-started" },
  { name: "Expo", icon: SiExpo, color: "#fff", subtitle: "Mobile", doc: "https://docs.expo.dev/" },
  { name: "React Native", icon: SiReact, color: "#61dafb", subtitle: "Mobile", doc: "https://reactnative.dev/docs/getting-started" },
  { name: "Flutter", icon: SiFlutter, color: "#02569B", subtitle: "Mobile", doc: "https://docs.flutter.dev/" },
  { name: "Dart", icon: SiDart, color: "#0175C2", subtitle: "Language", doc: "https://dart.dev/guides" },
  { name: "Git", icon: SiGit, color: "#F05032", subtitle: "Version Control", doc: "https://git-scm.com/doc" },
  { name: "GitHub", icon: SiGithub, color: "#fff", subtitle: "Code Hosting", doc: "https://docs.github.com/en" },
];

export const frontendTechsRow2 = [
  { name: "SolidJS", icon: SiSolid, color: "#2c4f7c", subtitle: "Framework", doc: "https://www.solidjs.com/docs" },
  { name: "jQuery", icon: SiJquery, color: "#0769ad", subtitle: "Library", doc: "https://api.jquery.com/" },
  { name: "Node.js", icon: SiNodedotjs, color: "#3c873a", subtitle: "Runtime", doc: "https://nodejs.org/en/docs" },
  { name: "Express.js", icon: SiExpress, color: "#fff", subtitle: "Backend", doc: "https://expressjs.com/en/starter/installing.html" },
  { name: "MongoDB", icon: SiMongodb, color: "#47A248", subtitle: "Database", doc: "https://www.mongodb.com/docs/" },
  { name: "Babel", icon: SiBabel, color: "#f9dc3e", subtitle: "Tooling", doc: "https://babeljs.io/docs/en/" },
  { name: "ESLint", icon: SiEslint, color: "#4b32c3", subtitle: "Linting", doc: "https://eslint.org/docs/latest/" },
  { name: "Prettier", icon: SiPrettier, color: "#f7b93e", subtitle: "Formatting", doc: "https://prettier.io/docs/en/index.html" },
  { name: "Jest", icon: SiJest, color: "#c21325", subtitle: "Testing", doc: "https://jestjs.io/docs/getting-started" },
  { name: "Figma", icon: SiFigma, color: "#a259ff", subtitle: "Design", doc: "https://help.figma.com/hc/en-us" },
  { name: "Zustand", icon: SiRedux, color: "#fff", subtitle: "State", doc: "https://docs.pmnd.rs/zustand/getting-started/introduction" },
  { name: "Integration", icon: FiLink, color: "#0074c1", subtitle: "API", doc: "https://restfulapi.net/" },
];
